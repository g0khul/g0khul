...
export const projects: Project[] = [
  {
    ...
    description:
      "A RESTful API for an e-commerce platform with authentication, product management, and order processing.",
  ...
  },
  {
    ...
    description:
      "WebSocket-based chat application with rooms, private messaging, and file sharing capabilities.",
  ...
  },
  {
    ...
    description:
      "Full-stack task management system with team collaboration, notifications, and analytics.",
